...
The best way to send feedback is to file an issue at https://github.com/syedhamidali/radarx/issues.
...
Ready to contribute? Here's how to set up `radarx` for local development.

1. Fork the `radarx` repo on GitHub.
...
3. The pull request should work for Python 3.5, 3.6, 3.7 and 3.8, and for PyPy. Check
   https://travis-ci.com/syedhamidali/radarx/pull_requests
